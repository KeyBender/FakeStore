...
<body>
			...
			<div class="collapse navbar-collapse show" id="navbarBasic">
				<ul class="navbar-nav me-auto mb-2 mb-xl-0">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="#onSale">On Sale</a></li>
	...
	<div class="bg-light d-flex justify-content-center mb-3 position-relative">
		<video autoplay muted loop width="100%">
			<source src="/img/mainPage.mp4">
		</video>
		<div class="position-absolute top-50 start-50 translate-middle">
			<h1 class="text-primary" style="font-size: 5rem;">Fake Store</h1>
		</div>
	</div>

	<div id="onSale" class="container-fluid">
		<div class="border-bottom">
			<h2 class="text-center text-primary">On Sale</h2>
		</div>
		<div class="row row-cols-4">
			<c:forEach var="item" items="${onSale }">
				<div class="col">
				<a href="/item/view/${item.id }" style="text-decoration: none;" class="text-dark">
					<div class="card m-3 shadow p-1 bg-white-rounded">
						<img src="${item.image }"
							class="card-img-top m-auto" alt="card-grid-image" style="height: 15rem; width: 15rem;">
						<div class="card-body">
