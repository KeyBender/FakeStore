	...
	<c:if test="${!emptyCart }">
		<div class="container-fluid mt-4">
			<div class="row">
				...
				<div class="col col-sm-3 border-start ps-3">
					<div class="row">
					...
					<div class="row">
						...
						<p>Not right? <a href="/user/${currentOrder.user.id }">Edit</a></p>
						
						<div class="border-top pt-3">
						<div class="d-flex gap-3">
							<h1>Total:</h1>
							<h1>$${currentOrder.totalPrice }</h1>
						</div>
						<div class="d-flex align-items-end" style="height: auto;">
